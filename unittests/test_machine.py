...
class MyTestCase(unittest.TestCase):
    def test_create_new_machine(self):
        ...
        for c in new_machine.chips:
            ...
            self.assertEqual(c.sdram,SDRAM)
    ...
    def test_create_new_machine_with_invalid_chips(self):
        with self.assertRaises(exc.SpinnMachineAlreadyExistsException):
            ...
            for x in range(5):
                for y in range(5):
                    chips.append(chip.Chip(x,y,processors,r,SDRAM,ip))
            chips.append(chip.Chip(0,0,processors,r,SDRAM,ip))
            new_machine = machine.Machine(chips)
    ...
    def test_machine_add_chip(self):
        ...
        extra_chip  = chip.Chip(5,0,processor,r,SDRAM,ip)
    ...
    def test_machine_add_chips(self):
        ...
        for x in range(5):
            for y in range(5):
                chips.append(chip.Chip(x,y,processors,r,SDRAM,ip))
                if x == 0:
                    extra_chips.append(chip.Chip(x+5,y,processors,r,SDRAM,ip))
        ...
        with self.assertRaises(exc.SpinnMachineAlreadyExistsException):
            ...
            for x in range(5):
                for y in range(5):
                    chips.append(chip.Chip(x,y,processors,r,SDRAM,ip))
                    if x == 0:
                        extra_chips.append(chip.Chip(x,y,processors,r,SDRAM,ip))
