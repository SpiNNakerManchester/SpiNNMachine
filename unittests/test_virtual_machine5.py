...
#                         "[VirtualMachine: max_x=1, max_y=1, n_chips=4]")
    ...
    def test_version_5_8_by_8(self) -> None:
        ...
        keys = {('127.0.0.0', 0, 0), ((7, 3), 0, 0), ((0, 0), 0, 0),
        ...
        expectes = {(7, 3, 0, 0, 0), (7, 3, 5, 0, 1), (6, 2, 0, 0, 2),
                    ...
                    (0, 0, 5, 0, 15), (0, 0, 4, 1, 0), (0, 0, 3, 1, 1),
                    (0, 1, 4, 1, 2), (0, 1, 3, 1, 3), (0, 2, 4, 1, 4),
                    (0, 2, 3, 1, 5), (0, 3, 4, 1, 6), (0, 3, 3, 1, 7),
                    (0, 3, 2, 1, 8), (1, 4, 3, 1, 9), (1, 4, 2, 1, 10),
                    (2, 5, 3, 1, 11), (2, 5, 2, 1, 12), (3, 6, 3, 1, 13),
                    (3, 6, 2, 1, 14), (4, 7, 3, 1, 15), (4, 7, 2, 2, 0),
                    (4, 7, 1, 2, 1), (5, 7, 2, 2, 2), (5, 7, 1, 2, 3),
                    (6, 7, 2, 2, 4), (6, 7, 1, 2, 5), (7, 7, 2, 2, 6),
                    (7, 7, 1, 2, 7), (7, 7, 0, 2, 8), (7, 6, 1, 2, 9),
                    (7, 6, 0, 2, 10), (7, 5, 1, 2, 11), (7, 5, 0, 2, 12),
                    (7, 4, 1, 2, 13), (7, 4, 0, 2, 14), (7, 3, 1, 2, 15)}
